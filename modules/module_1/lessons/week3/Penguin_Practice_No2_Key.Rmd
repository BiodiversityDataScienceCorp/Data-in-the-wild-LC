...
First we need to load the penguin data set, just like last week. The dataset will be called *penguins*
This data was collected by real scientists! Data were collected and made available by Dr. Kristen Gorman and the Palmer Station, Antarctica LTER, a member of the Long Term Ecological Research Network.
```{r}
